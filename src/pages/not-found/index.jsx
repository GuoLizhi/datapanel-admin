...
const NotFound = () => {
  ...
  return <div className="not-found-page">
      ...
      <svg width="252" height="294">
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <path
            ...
            fill="#7BB2F9"
          ></path>
          <path d="M76.085 221.626c1.153.094 4.038-2.019 6.955-4.935M106.36 225.142s2.774-1.11 6.103-3.883" stroke="#648BD8"
          ...
          ></path>
          <path d="M129.405 122.865s-5.272 7.403-9.422 10.768" stroke="#E4EBF7" strokeWidth="1.051" strokeLinecap="round"
            strokeLinejoin="round"
          ></path>
          <path d="M119.306 107.329s.452 4.366-2.127 32.062" stroke="#E4EBF7" strokeWidth="1.101" strokeLinecap="round"
            strokeLinejoin="round"
          ></path>
          <path
          ...
          <path
            ...
            fill="#FFC6A0"
          ></path>
          <path d="M153.686 133.577s-6.522.47-8.36.372c-1.836-.098-1.904 2.19 2.359 2.264 3.739.15 5.451-.044 5.451-.044"
            stroke="#DB836E" strokeWidth="1.051" strokeLinecap="round" strokeLinejoin="round"
          ></path>
          <path d="M145.16 135.877c-1.85 1.346.561 2.355.561 2.355s3.478.898 6.73.617" stroke="#DB836E" strokeWidth="1.051"
    ...
    <div className="footer">
      <h2>404</h2>
      <p className="title">页面找不到了</p>
      <Button type="primary" onClick={goHome} className="back-home">返回首页</Button>
    </div>
  </div>
}
